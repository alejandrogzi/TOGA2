...
DEFAULT_ARGS: Dict[str, Union[str, int, float]] = {
    ...
    'cesar_non_canon_u2_acceptor': os.path.join(HUMAN_PROFILES, 'nonCanon_U2_acceptor.tsv'),
    ...
    'cesar_non_canon_u12_acceptor': os.path.join(HUMAN_PROFILES, 'canon_U12_acceptor.tsv'),
    'cesar_non_canon_u12_donor': os.path.join(HUMAN_PROFILES, 'non_canon_U12_acceptor.tsv'),
