...
(
    ...
    lstring query_region; "Region in the query"
    ...
    lstring cds_line; "Nucleotide coding sequence"
    lstring ucorr_protein; "Frame-corrected protein sequence"

    int num_affected_exon; "Number of mutation-affected exons"
    float perc_affected_exons; "Fraction of mutaiton-affected exons"
)
